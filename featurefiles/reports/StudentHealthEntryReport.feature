...
#test cases of all filters selection
  ...
  Scenario: To verify student health entry report with filters
    And select class on student health entry report
    Then click show on student health entry report

#test cases on selection of radio buttons
  @verify_with_no_filters @scenario2
  Scenario: To verify student health entry report with no filters
    Then click show on student health entry report