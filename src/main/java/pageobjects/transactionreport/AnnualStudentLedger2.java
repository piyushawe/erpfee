...
public class AnnualStudentLedger2 extends GenericReports {
    @FindBy(linkText = "Annual Student Ledger 2")private WebElement link;
    @FindBy(id = "Annual Student Ledger 2")private WebElement frame;
    ...
    public void openAnnualStudentLedger2() throws IOException {
